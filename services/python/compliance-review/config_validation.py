"""Boot-time configuration validation for the compliance-review service.
...
REQUIRED_ENV_VARS = (
    ...
    "COMPLIANCE_PROVIDER_NAME",
    "COMPLIANCE_PROVIDER_VERIFY_URL",
    "COMPLIANCE_PROVIDER_HMAC_SECRET",
)
