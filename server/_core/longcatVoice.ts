...
function buildDatabaseSsl(useSsl: boolean) {
  ...
  if (ENV.databaseTlsSkipVerify) {
    console.warn(
      "[SECURITY] DATABASE_TLS_SKIP_VERIFY=true: TLS certificate verification is DISABLED for the LongCat voice database connection. This is a development-only override and is rejected in production.",
    );
