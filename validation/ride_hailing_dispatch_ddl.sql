...
-- This is an implementation-grade design artefact. Run it as a reviewed, ordered migration
-- only after confirming extension availability, privacy controls, and regulator/insurance approvals.
