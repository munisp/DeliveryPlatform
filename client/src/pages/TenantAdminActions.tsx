...
async function downloadInvitationActivity(filters: { status: string; startDate: string; endDate: string }) {
...
export default function TenantAdminActions() {
  ...
  const exportCsv = useMutation({ mutationFn: () => downloadInvitationActivity({ status: activityStatus, startDate: activityStartDate, endDate: activityEndDate }) });
